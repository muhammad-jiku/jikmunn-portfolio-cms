      ...
      >
        <div className="text-center mb-6 sm:mb-8">
          <motion.div
            ...
            className="inline-flex h-12 w-12 sm:h-14 sm:w-14 md:h-16 md:w-16 rounded-full bg-linear-to-br from-primary to-secondary items-center justify-center mb-3 sm:mb-4 shadow-lg"
            style={{ boxShadow: '0 10px 40px -10px rgb(124 58 237 / 0.5)' }}
          >
            <Lock className="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 text-white" />
          </motion.div>
          <motion.h1
