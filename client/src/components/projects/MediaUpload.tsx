...
export default function MediaUpload({ media, onChange, maxFiles = 10 }: MediaUploadProps) {
  ...
  return (
    <div>
      <label className="block text-sm font-medium mb-2">Media (Images/Videos)</label>
          ...
          {media.map((item, index) => (
            ...
            >
              ...
              <div className="aspect-video relative">
                ...
                {/* Order Badge */}
                <div className="absolute top-2 right-2 w-6 h-6 bg-black/50 rounded-full flex items-center justify-center text-xs text-white font-semibold">
                  {index + 1}
                </div>
